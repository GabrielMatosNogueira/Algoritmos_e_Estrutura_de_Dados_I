...
---------------------------------------------------------------------------------------------------
*/
double calcularDistancia(double matriz[][2], int nLinhas, int nColunas) 
{
    if (nLinhas < 2 || nColunas != 2) return 0.0;
    double dx = matriz[nLinhas-1][0] - matriz[0][0];
    double dy = matriz[nLinhas-1][1] - matriz[0][1];
